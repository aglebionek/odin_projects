...
draw_platform :: proc(pos: rl.Vector2) {
	rl.DrawRectangleV(pos, {10, 10}, rl.GREEN)
}
...
update :: proc() {
	...
	if rl.IsKeyDown(.R) {
		libc.system("build_hot_reload.bat")
	}
...
game_init :: proc() {
	...
	g_mem^ = Game_Memory {
		...
		player_texture = rl.LoadTexture("assets/kot.png"),
	}
